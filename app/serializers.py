...
# school_name","sub_domen","school_logo_1","school_logo_2",
...
class CreateappUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = appUser
        exclude = ("client_activity","lead_activity","last_login","is_active","is_staff","is_superuser","groups","user_permissions","is_online")
